...
export const getCustomerMedicalRecordRouteOptions = {
	schema: {
		...
		description:
			"Customers can read their own medical record. Healthcare providers can read records only for patients who have confirmed appointments with them, and only when at least one medical record field is filled.",
		security: [{ bearerAuth: [] }],
